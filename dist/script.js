...
/* harmony import */ var _changeNumInput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./changeNumInput */ "./src/js/modules/changeNumInput.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_changeNumInput__WEBPACK_IMPORTED_MODULE_1__["default"])("#width");
  Object(_changeNumInput__WEBPACK_IMPORTED_MODULE_1__["default"])("#height");
...
var changeNumInput = function changeNumInput(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeNumInput);
...
/* harmony import */ var _changeNumInput__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./changeNumInput */ "./src/js/modules/changeNumInput.js");
...
var forms = function forms(state) {
  ...
  Object(_changeNumInput__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  var message = {
    loading: "Загрузка...",
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      postDate("server.php", formDate).then(function (res) {
        console.log(res);
        statusMessage.textContent = message.success;
      }).catch(function () {
        return statusMessage.textContent = message.fialure;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var clodeClickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    ...
    modal.addEventListener("click", function (e) {
      if (e.target === modal && clodeClickOverlay) {
        windows.forEach(function (item) {
          item.style.display = "none";
        });
        modal.style.display = "none";
